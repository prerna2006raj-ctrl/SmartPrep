...
function Dashboard() {
  ...
  if (loading) return <p className="text-center mt-10">Loading your performance data...</p>;
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-6 py-10">
      <h1 className="text-3xl font-bold text-blue-700 mb-8 text-center">Your Performance</h1>

      {attempts.length === 0 ? (
        <p className="text-center text-gray-500 mt-10">
          You haven't attempted any mock tests yet. Take one to see your progress here!
        </p>
      ) : (
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="bg-white shadow-md rounded-lg p-5 text-center">
              ...
              <p className="text-3xl font-bold text-blue-700">{attempts.length}</p>
            </div>
            <div className="bg-white shadow-md rounded-lg p-5 text-center">
          ...
          <div className="bg-white shadow-md rounded-lg p-5 mb-8">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <LineChart data={chartData}>
                ...
                <YAxis domain={[0, 100]} />
                <Tooltip />
                <Line type="monotone" dataKey="percentage" stroke="#1d4ed8" strokeWidth={2} />
              </LineChart>
            </ResponsiveContainer>
          </div>

          <div className="bg-white shadow-md rounded-lg p-5">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Attempt History</h2>
            <div className="space-y-2">
              {attempts.map((a) => (
                <div key={a._id} className="flex justify-between border-b border-gray-100 py-2 text-sm">
